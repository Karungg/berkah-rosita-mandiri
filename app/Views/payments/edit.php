...
<div class="col-12"> <!-- Default box -->
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?= form_open_multipart('admin/payments/' . $payment[0]['id_pembayaran'] . '/edit') ?>
            <?= csrf_field() ?>
            <?= form_hidden('id_pembayaran', $payment[0]['id_pembayaran']) ?>
            <?= form_hidden('_method', 'PUT') ?>
            <div class="mb-3">
                <label for="nama_pembeli" class="form-label">Nama Pembeli</label>
                <input type="text" class="form-control <?= (isset($errors['nama_pembeli'])) ? 'is-invalid' : '' ?>" id="nama_pembeli" name="nama_pembeli" value="<?= $payment[0]['nama_pembeli'] ?>">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control <?= (isset($errors['alamat'])) ? 'is-invalid' : '' ?>" id="alamat" name="alamat"><?= $payment[0]['alamat'] ?></textarea>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control <?= (isset($errors['no_telp'])) ? 'is-invalid' : '' ?>" id="no_telp" name="no_telp" value="<?= $payment[0]['no_telp'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control <?= (isset($errors['tgl_pembayaran'])) ? 'is-invalid' : '' ?>" id="tgl_pembayaran" name="tgl_pembayaran" value="<?= $payment[0]['tgl_pembayaran'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($errors['metode_pembayaran'])) ? 'is-invalid' : '' ?>" id="metode_pembayaran" name="metode_pembayaran" value="<?= $payment[0]['metode_pembayaran'] ?>">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control <?= (isset($errors['total'])) ? 'is-invalid' : '' ?>" id="total" name="total" value="<?= $payment[0]['total'] ?>">
                <div class="invalid-feedback">
