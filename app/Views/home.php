...
<body>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <h1 class="display-4 text-white animated slideInRight">
                        Hair <span class="fw-light text-dark">Shampoo</span> For Healthy
                        Hair
                    </h1>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid animated pulse infinite" src="<?= base_url('template/') ?>img/shampoo.png" alt="" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="<?= base_url('template/') ?>img/shampoo-1.png" />
                </div>
    ...
    <div class="container-fluid deal bg-primary my-5 py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="<?= base_url('template/') ?>img/shampoo-2.png" />
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="<?= base_url('template/') ?>img/shampoo.png" />
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="row g-5">
                        <div class="col-12 d-flex">
        ...
        <div class="container text-white py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-4 text-center wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                ...
                <div class="col-lg-8">
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
                        <div class="testimonial-item text-center" data-dot="1">
                            <img class="img-fluid border p-2" src="<?= base_url('template/') ?>img/testimonial-1.jpg" alt="" />
                        ...
                        <div class="testimonial-item text-center" data-dot="2">
                            <img class="img-fluid border p-2" src="<?= base_url('template/') ?>img/testimonial-2.jpg" alt="" />
                            <h5 class="fw-light lh-base text-white">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                                aliquet, erat non malesuada consequat, nibh erat tempus risus,
                                vitae porttitor purus nisl vitae purus. Praesent tristique
                        ...
                        <div class="testimonial-item text-center" data-dot="3">
                            <img class="img-fluid border p-2" src="<?= base_url('template/') ?>img/testimonial-3.jpg" alt="" />
                            <h5 class="fw-light lh-base text-white">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                                aliquet, erat non malesuada consequat, nibh erat tempus risus,
                                vitae porttitor purus nisl vitae purus. Praesent tristique
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="<?= base_url('template/') ?>img/blog-1.jpg" alt="" />
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="<?= base_url('template/') ?>img/blog-2.jpg" alt="" />
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="<?= base_url('template/') ?>img/blog-3.jpg" alt="" />
