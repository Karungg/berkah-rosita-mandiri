    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?= (isset($errors['nama_produk'])) ? 'is-invalid' : '' ?>" id="nama_produk" name="nama_produk" value="<?= old('nama_produk') ?>">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control <?= (isset($errors['harga'])) ? 'is-invalid' : '' ?>" id="harga" name="harga" value="<?= old('harga') ?>">
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control <?= (isset($errors['stok'])) ? 'is-invalid' : '' ?>" id="stok" name="stok" value="<?= old('stok') ?>">
                <div class="invalid-feedback">
